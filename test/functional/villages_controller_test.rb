...
class VillagesControllerTest < ActionController::TestCase
  ...
  test "should create village" do
    assert_difference('Village.count') do
      post :create, village: { dong: @village.dong, gu: @village.gu, si: @village.si, url: @village.url, village: @village.village }
    end
  ...
  test "should update village" do
    put :update, id: @village, village: { dong: @village.dong, gu: @village.gu, si: @village.si, url: @village.url, village: @village.village }
    assert_redirected_to village_path(assigns(:village))
  end
